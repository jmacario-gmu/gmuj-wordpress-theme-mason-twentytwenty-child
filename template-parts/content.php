		...
		<div class="gmuj-sidebar-wrapper">
			...
			<div class="entry-content">
				...
				if ( is_search() || ! is_singular() && 'summary' === get_theme_mod( 'blog_content', 'full' ) ) {
					...
					// If this post is a post of the custom post type: person, insert the person content template. If not, use the normal template.
					if (get_post_type()=='person') {
						get_template_part('template-parts/sub-content','person');
					} else {
